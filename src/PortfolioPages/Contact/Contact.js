...
const Contact = () => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_88gnsxk', 'template_lqvju9b', e.target, 'user_4AQpCSOztDQhPAlu5M9AF' )
    .then(res => {
      if(res.status === 200){
  ...
  return (
    <section id="contact" className="contact_section">
      <div className="contact_parent">
        ...
        <div className="container contact_parent_role">
          <div className="row">
            <div className="col-md-5 col-lg-4 col-sm-12 location_area shadow">
            ...
            <div className="col-lg-6 col-sm-12 col-md-6 contact_area">
             {status && <p className="text-center" style={{color: "green" , fontSize:"18px", fontWeight: "bold"}}>Your Information Send Successfully</p>}
